...
route.post("/AddProducts",middleware.Protect, PictureMiddle.single("Product_Picture"), Products_Controllers.Create_Products);
...
route.delete("/DeleteProduct/:id",middleware.Protect,middleware.isAdmin, Products_Controllers.Delete_spec_Product);
